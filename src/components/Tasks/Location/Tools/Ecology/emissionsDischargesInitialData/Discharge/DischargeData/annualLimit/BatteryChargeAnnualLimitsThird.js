...
const BatteryChargeAnnualLimitsThird = ({numberBatteries}) => {
    let {batteriesGPES, batteriesDES, accumulatorC02, accumulatorPumpingStation, powerstar, leochDjm, spinter, Marathon} = numberBatteries

    // Battery capacity (Limit section)
    // Get Object from quarterReport.js
    return (
        <div>
